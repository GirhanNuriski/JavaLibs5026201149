...
public class JavaLibs5026201149 {
    public static void main(String[] args) {
        ...
        int ratingPlace, ratingDrink, userAge, jumlahMinuman, ratingPelayanan;
        int hargaMinuman = 15000;
        double pajakMinuman = 0.1;
        double rekomHarga;
        double hargaAkhir = (hargaMinuman + hargaMinuman * pajakMinuman);
        ...
        JOptionPane.showMessageDialog(null, "Total harga yang harus dibayar adalah " +"Rp. " +hargaAkhir);
        ...
        JOptionPane.showMessageDialog(null, "Ini adalah survey kepuasan dan kalkulator yang disediakan oleh" +
                ...
                "Lalu, " +userName +" memesan " +jumlahMinuman +" " +namaMinuman +". " +userName +" harus membayar Rp." +hargaAkhir +". Terimakasih banyak telah mengisi!");
    }
}
